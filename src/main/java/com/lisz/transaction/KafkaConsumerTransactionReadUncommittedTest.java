...
public class KafkaConsumerTransactionReadUncommittedTest {
    public static void main(String[] args) throws Exception {
        ...
        //设置消费者的消费事务的隔离级别
        props.put(ConsumerConfig.ISOLATION_LEVEL_CONFIG, "read_uncommitted");//默认就是这个

        KafkaConsumer<String, String> consumer = new KafkaConsumer<String, String>(props);
        consumer.subscribe(Arrays.asList("topic01"));//可以用到组管理机制：组内负载均衡，组间广播
        while (true) {
