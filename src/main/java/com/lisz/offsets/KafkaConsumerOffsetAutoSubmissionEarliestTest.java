...
public class KafkaConsumerOffsetAutoSubmissionEarliestTest {
    public static void main(String[] args) throws Exception {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "g3");//这里与KafkaConsumerOffsetTest中的设置不同，是g2，是一个崭新的组，没有消费过topic02 （每次测试要设置一个新组）
        ...
        //配置offset自动提交的时间间隔
        //做实验的时候在消费完之后10s以内退出，还没来得及提交offset
