...
public class KafkaConsumerOffsetManualAsyncSubmissionEarliestTest {
        ...
        while (true) {
            ...
            if (!consumerRecords.isEmpty()) { //从队列中取到了数据
                ...
                records.forEach(r->{
                    ...
                    //注意，这里提交的应该是下一次该读哪个位置了，要加1
                    map.put(new TopicPartition(topic, partition), new OffsetAndMetadata(offset + 1));
